...
class MyForm(QMainWindow, Ui_helloworld.Ui_MainWindow):
#                         ^^^^^^^^^^^   Change this!
    ...
    # END DO NOT MODIFY
        ...
        self.pushButtonHello.clicked.connect(self.hellobutton_clicked)
...
#       Make a call to the Save() helper function here
    ...
    def SetMessage(self):
        ...
        self.lineEditMessage.setText("Hello World")
